...
public class C10Print {
	public static void main(String[] args) {
		...
		System.out.printf("%05d%n",99);//5칸차지했는데 0으로 채워라
		System.out.printf("%1$05d%n",99);
		
		System.out.printf("%010f%n",3.14);
		
		//precision : 소수점 이하 자릿수
		System.out.printf("%10.6f%n",3.14);//소수점이하 6자리는 기본값
		System.out.printf("%10.3f%n",3.14);//소수점이하 3자리를 차지해라
		System.out.printf("%10.3f%n",3.55555);
